...
const { addBlogTag, editBlogTag, getBlogTags, getBlogTagById, deleteBlogTag, getBlogTagsWithoutToken, getActiveBlogTags } = require("../../controllers/mastercontrollers/blogTagController");
...
router.get("/active", getActiveBlogTags);
