...
const { addPropertyType, editPropertyType, getPropertyTypes, getPropertyTypeById, deletePropertyType } = require("../../controllers/mastercontrollers/propertyTypeController");
